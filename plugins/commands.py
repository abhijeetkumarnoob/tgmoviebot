...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('updates', url='https://t.me/Before_Dm')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('updates', url='https://t.me/Before_Dm'),
            InlineKeyboardButton('movie channel', url='https://t.me/Before_Dm')
            ],[
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            buttons = [
                [
                    InlineKeyboardButton('support', url='https://t.me/Before_Dm'),
                    InlineKeyboardButton('channel', url='https://t.me/Before_Dm')
                ],
                [
                    InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/Before_Dm')
                ]
                ]
            try:
